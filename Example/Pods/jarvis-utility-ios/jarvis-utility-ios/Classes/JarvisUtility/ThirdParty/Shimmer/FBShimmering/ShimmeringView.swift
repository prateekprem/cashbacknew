...
import UIKit
 ...
 open class ShimmeringView: UIView {
    ...
    open var isShimmering: Bool = false {
    ...
    /// Defaults to 230.
    open var shimmeringSpeed: CGFloat = 230.0 {
        didSet { shimmerLayer?.shimmerSpeed = shimmeringSpeed }
    }

    /// The highlight length of the shimmer. Range of [0,1], defaults to 1.0.
    open var shimmerHighlightLength: CGFloat = 1.0 {
    ...
    open var shimmerBeginFadeDuration: CFTimeInterval = 0.1 {
    ...
    open var shimmerEndFadeDuration: CFTimeInterval = 0.3 {
    ...
    open var shimmerFadeTime: CFTimeInterval? {
