//
//  JRLFloatingTextField.swift
//  JRLFloatingTextField
//
...
@IBDesignable
@objc open class JRLFloatingTextField: UITextField {
    ...
    @IBInspectable open var selectedLineColor : UIColor = LOGINCOLOR.darkGreen{
        didSet{
            self.floatTheLabel()
        }
    }
    ...
    @IBInspectable open var selectedPlaceHolderColor : UIColor = LOGINCOLOR.darkGreen{
        didSet{
            self.floatTheLabel()
        }
    }
...
fileprivate extension JRLFloatingTextField {
    ...
    func addFloatingLabel(){
        ...
        labelPlaceholder?.font = labelPlaceholder?.font.withSize(12)
    ...
    func addErrorPlaceholderLabel() -> Void {
        ...
        labelErrorPlaceholder?.font = labelPlaceholder?.font.withSize(12)
    ...
    func floatPlaceHolder(selected:Bool) -> Void {
        ...
        if selected {
            ...
            bottomLineViewHeight?.constant = 2;
            setPlaceholderColor(selectedPlaceHolderColor)
